...
const translations: Record<LanguageType, Translations> = {
  pt: {
    ...
    parentsGateSubtitle: "Digite o PIN de 4 dígitos para entrar:",
    ...
    game1Title: "Mundo das Sílabas",
    game1Desc: "Ache as sílabas escondidas no cenário interativo!",
    game1Prompt: "Ouça e encontre a sílaba correspondente!",
    game2Title: "Sílabas Camufladas",
    game2Desc: "Identifique a sílaba solicitada entre os objetos!",
    game2Prompt: "Ouça a sílaba e encontre onde ela está!",
    game3Title: "Captura de Sílabas",
    game3Desc: "Estoure as bolhas da sílaba certa antes que sumam!",
    game3Prompt: "Ouça e capture as sílabas corretas!",
    game4Title: "Som e Sílabas",
  ...
  en: {
    ...
    parentsGateSubtitle: "Enter the 4-digit PIN to access:",
    ...
    game1Title: "World of Syllables",
    game1Desc: "Find the hidden syllables in the interactive scene!",
    game1Prompt: "Listen and find the corresponding syllable!",
    game2Title: "Camouflaged Syllables",
    game2Desc: "Identify the requested syllable among the items!",
    game2Prompt: "Listen to the syllable and find where it is!",
    game3Title: "Syllable Catch",
    game3Desc: "Pop the bubbles with the correct syllable before they disappear!",
    game3Prompt: "Listen and catch the correct syllables!",
    game4Title: "Sound and Syllables",
  ...
  it: {
    ...
    parentsGateSubtitle: "Inserisci il PIN a 4 cifre per entrare:",
    ...
    game1Title: "Mondo delle Sillabe",
    game1Desc: "Trova le sillabe nascoste nello scenario interattivo!",
    game1Prompt: "Ascolta e trova la sillaba corrispondente!",
    game2Title: "Sillabe Mimetizzate",
    game2Desc: "Identifica la sillaba richiesta tra gli oggetti!",
    game2Prompt: "Ascolta la sillaba e trova dov'è!",
    game3Title: "Cattura delle Sillabe",
    game3Desc: "Fai scoppiare le bolle con la sillaba giusta prima che spariscano!",
    game3Prompt: "Ascolta e cattura le sillabe corrette!",
    game4Title: "Suono e Sillabe",
  ...
  es: {
    ...
    parentsGateSubtitle: "Ingresa el PIN de 4 dígitos para entrar:",
    parentsGatePlaceholder: "Resultado",
    ...
    game1Title: "Mundo de las Sílabas",
    game1Desc: "¡Encuentra las sílabas ocultas en el escenario interactivo!",
    game1Prompt: "¡Escucha y encuentra la sílaba correspondiente!",
    game2Title: "Sílabas Camufladas",
    game2Desc: "¡Identifica la sílaba solicitada entre los objetos!",
    game2Prompt: "¡Escucha la sílaba y encuentra dónde está!",
    game3Title: "Captura de Sílabas",
    game3Desc: "¡Explota las burbujas de la sílaba correcta antes de que desaparezcan!",
    game3Prompt: "¡Escucha y captura las sílabas correctas!",
    game4Title: "Sonido y Sílabas",
